...
## Задача №1 <a href="https://github.com/RavenRVS/HW_Functions/blob/main/main/main.py">(Решение)</a>
...
## Задача №2. Дополнительная (не обязательная) <a href="https://github.com/RavenRVS/HW_Functions/blob/main/main/main.py">(Решение)</a>
