...
## Задача №1 <a href="https://github.com/RavenRVS/HW_Functions/blob/main/main/main.py">(моё решение)</a>
...
## Задача №2. Дополнительная (не обязательная) <a href="https://github.com/RavenRVS/HW_Functions/blob/main/main/main.py">(моё решение)</a>
